...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(!$connection) {
		...
		if($count == 1 ) {
			...
			header("location: http://localhost/TehnologiiWeb");
...
<nav style="background: #f8f8f8" class="navbar navbar-default navbar-expand-xl navbar-light">
	...
	<div class="login-form">
		...
		<p class="text-center text-muted small">Don't have an account? <a href="http://localhost/TehnologiiWeb/header/register.php">Sign up here!</a></p>
	</div>
